 ...
 */
@AllArgsConstructor
public enum InviteStatus implements Dict {
    ...
    static final Map<Integer, InviteStatus> dicts = new HashMap<>();
    static final Map<Integer, String> labels = new LinkedHashMap<>();

    static {
        InviteStatus[] array = InviteStatus.values();
    ...
    public static InviteStatus valueOf(Integer val) {
