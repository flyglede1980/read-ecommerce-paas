package net.yitun.basic.security.support.exp;
...
public class SecurityException extends RuntimeException {
    ...
    public SecurityException(int code, String message, Object input) {
        super(message);
        this.code = code;
        this.input = input;
    }

    public SecurityException(int code, String message, Object input, Throwable cause) {
        super(message, cause);
        this.code = code;
        this.input = input;
    }
