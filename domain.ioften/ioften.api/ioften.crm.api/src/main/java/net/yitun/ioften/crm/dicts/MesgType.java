 ...
 */
@AllArgsConstructor
public enum MesgType implements Dict {
    ...
    static final Map<Integer, MesgType> dicts = new HashMap<>();
    static final Map<Integer, String> labels = new LinkedHashMap<>();

    static {
        MesgType[] array = MesgType.values();
    ...
    public static MesgType valueOf(Integer val) {
