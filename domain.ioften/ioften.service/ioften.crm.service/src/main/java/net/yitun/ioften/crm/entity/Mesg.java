...
public class Mesg implements Serializable {
    ...
    @ApiModelProperty(value = "参与者, 0:系统; 其他为用户ID, 外键: crm_user.id")
    ...
    public Mesg(Long id, Long uid, MesgType type, Long actor, Long target, String content, Integer times, YesNo status,
